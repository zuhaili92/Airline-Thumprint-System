                ...
                <div class="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <ul class="sidebar-nav">
                            ...
                            <li  class="<?php if(strchr($_SERVER['REQUEST_URI'],"?site=createflight")){ echo 'active'; } ?>">
                                <a href="?site=createflight"><i class="gi gi-charts sidebar-nav-icon"></i>Create Flight</a>
                            </li>
                            <li class="<?php if(strchr($_SERVER['REQUEST_URI'],"?site=manageflight")){ echo 'active'; } ?>">
                                <a href="?site=manageflight"><i class="gi gi-share_alt sidebar-nav-icon"></i>Manage Flight</a>
                            </li>
