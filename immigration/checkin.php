...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="block">
            ...
            <form action="index.php?site=search_data" method="post" class="form-horizontal form-bordered">
                ...
                <div class="form-group form-actions">
                    <div class="col-md-9 col-md-offset-3">
                        <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-angle-right"></i> Check in</button>
